...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "BOT"

        #Project url
        self.project_url = "https://github.com/seenbeen/bot"
        ...
        #Auhor of program
        self.author_name = "Ashkan Z. & Shiyang H."
        self.author_email = "shiyang.han@hotmail.com, ashkan.zirakzdeh@gmail.com"
        self.copyright = "Copyright (c) 2018 Wave of Heroes."

        #Description
        self.project_description = "Will be Updated as we go."

        #Icon file (None will use pygame default icon)
        self.icon_file = None # will be replaced later

        #Extra files/dirs copied to game
        self.extra_datas = [] # will be filled in later
